...
| 类别         | 硬性规则                                                                                                       | 深入文档                                                                                                                                             |
| ------------ | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| I18n         | 前端和后端用户可见文案必须来自 scoped `@tetap/i18n/*`；先改 `zh-CN`，再保持其他 locale 同 key。                | [README.zh-CN.md#i18n-规则](README.zh-CN.md#i18n-规则)、[packages-i18n.md](docs/Logical%20Architecture%20Diagram/packages-i18n.md)                   |
...
| Workspace            | 文档                                                                                 | 一句话职责                                                       |
| -------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| `apps/web`           | [apps-web.md](docs/Logical%20Architecture%20Diagram/apps-web.md)                     | React + Vite 浏览器 runtime、宣传首页、路由和页面组合。          |
