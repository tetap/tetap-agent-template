...
| `createDemoIamData`                                                                | Seed admin users, frontend users, roles, permissions, menus, policies.                                                               |
...
| `listSessions`                                                                     | Return frontend online sessions only; admin sessions remain private.                                                                 |
