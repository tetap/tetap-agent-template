...
const AlertDialogTitle = React.memo(function AlertDialogTitle({ className, ref, ...props }: AlertDialogTitleProps) {
...
const AlertDialogAction = React.memo(function AlertDialogAction({ className, ref, ...props }: AlertDialogActionProps) {
  return <AlertDialogPrimitive.Action ref={ref} className={cn(buttonVariants(), className)} {...props} />;
});
AlertDialogAction.displayName = AlertDialogPrimitive.Action.displayName;

const AlertDialogCancel = React.memo(function AlertDialogCancel({ className, ref, ...props }: AlertDialogCancelProps) {
  return (
