...
const SheetOverlay = React.memo(function SheetOverlay({ className, ref, ...props }: SheetOverlayProps) {
  return (
...
const SheetHeader = React.memo(function SheetHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('flex flex-col space-y-2 text-center sm:text-left', className)} {...props} />;
});
SheetHeader.displayName = 'SheetHeader';

const SheetFooter = React.memo(function SheetFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2', className)} {...props} />;
});
SheetFooter.displayName = 'SheetFooter';

const SheetTitle = React.memo(function SheetTitle({ className, ref, ...props }: SheetTitleProps) {
  return (
...
const SheetDescription = React.memo(function SheetDescription({ className, ref, ...props }: SheetDescriptionProps) {
