...
const SelectTrigger = React.memo(function SelectTrigger({ className, children, ref, ...props }: SelectTriggerProps) {
  return (
...
const SelectLabel = React.memo(function SelectLabel({ className, ref, ...props }: SelectLabelProps) {
  return <SelectPrimitive.Label ref={ref} className={cn('px-2 py-1.5 text-sm font-semibold', className)} {...props} />;
});
SelectLabel.displayName = SelectPrimitive.Label.displayName;

const SelectItem = React.memo(function SelectItem({ className, children, ref, ...props }: SelectItemProps) {
  return (
...
const SelectSeparator = React.memo(function SelectSeparator({ className, ref, ...props }: SelectSeparatorProps) {
