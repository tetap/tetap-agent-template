...
const DialogOverlay = React.memo(function DialogOverlay({ className, ref, ...props }: DialogOverlayProps) {
  return (
...
const DialogTitle = React.memo(function DialogTitle({ className, ref, ...props }: DialogTitleProps) {
  return (
...
const DialogDescription = React.memo(function DialogDescription({ className, ref, ...props }: DialogDescriptionProps) {
  return (
