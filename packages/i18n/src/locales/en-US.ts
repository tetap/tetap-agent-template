...
export const enUS = {
  ...
  webAdmin: {
    ...
    auth: {
      signIn: {
        ...
        loginFailed: 'Unable to sign in. Check the account information and try again.',
        loginServiceUnavailable: 'Unable to reach backend-admin. Confirm the service is running.',
      },
      otp: {
  ...
  error: {
    ...
    adminAccountDisabled: 'The admin account is disabled. Contact an administrator.',
    adminAccountLocked: 'The admin account is locked. Contact an administrator.',
